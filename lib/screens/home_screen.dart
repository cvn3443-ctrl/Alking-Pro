  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          if (_isLoggedIn)
            IconButton(icon: const Icon(Icons.settings), onPressed: _showSettingsPanel),
        ],
      ),
      body: _isLoggedIn
          ? Row(
              children: [
                // يسار: سجل الصفقات والإحصائيات
                Expanded(
                  flex: 1,
                  child: Container(
                ...
                // يمين: WebView المنصة
                Expanded(flex: 2, child: WebViewWidget(controller: _webViewController)),
              ],
            )
          : Center(
              child: Padding(
